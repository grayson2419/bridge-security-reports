  ...
  Scope: ALL chains and ALL cross-chain infrastructure — Ethereum, BSC, Solana, Arbitrum, Optimism, Polygon, Avalanche, Base, zkSync, Starknet, Cosmos, Polkadot, Near, Aptos, Sui, TON, Tron, plus OFT adapters (LayerZero), messaging protocols    
  (Wormhole, IBC, Hyperbridge, Axelar), etc.                                                                                                                                                                                                         
  ...
  **根因 | Root Cause:** [1句中英]
  ...
  ```"""
      ...
      # Handle pause_turn from server-side tool loops                                                                                                                                                                                                
      for _ in range(5):
